...
object Function {
  ...
  // TO BE IMPLEMENTED 
    lift7(f)(t1y, t2y, t3y, t4y, t5y, t6y, t7y)
  ...
  // TO BE IMPLEMENTED
  // t2 return a function that receives t1
  // the new function receives t1 and return a function2 receives t2 and return R
    t2 => t1 => f(t1)(t2)
